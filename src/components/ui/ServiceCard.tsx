...
export default function ServiceCard({ title, description, href, image }: ServiceCardProps) {
  return (
    ...
    >
      ...
      <div className="relative h-56 overflow-hidden bg-white group-hover:bg-accent/5 transition-colors duration-500 flex items-center justify-center p-8">
        <img
          src={image}
      ...
      <div className="p-8 flex flex-col flex-grow">
        <h3 className="text-xl font-bold text-text-dark mb-3 group-hover:text-primary transition-colors leading-tight flex items-center gap-3">
          {title}
        </h3>
